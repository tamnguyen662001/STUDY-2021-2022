...
ALTER TABLE KETQUA
DROP CONSTRAINT PK__KETQUA__2725081AF67B2776

ALTER TABLE KETQUA
ADD CONSTRAINT PK_KETQUA PRIMARY KEY (MaKhoaHoc, MaSV)
...
INSERT GIANGDAY VALUES('K2','GV04','KTLT',1,2001)
...
where kq.Diem>=ALL (select max(kq.Diem) from KETQUA kq) and mh.TenMH='KY THUAT LAP TRINH'
/* Câu 43*/
...
/* Câu 45*/
Câu 45: SELECT mh.mamh, tenmh, ten, diem 
